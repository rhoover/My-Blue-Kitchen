...
<h2 class="events-list-header">My 2025 Farmers Market Appearances</h2>
...
<section class="events-items">
  <div class="events-item">
    ...
    <p class="events-item-days">April 19th, 10:00am - 1:00pm</p>
    <p class="events-item-days">Summer Season Dates</p>
    <p class="events-item-daytime">Saturdays 9:00am - 1:00pm</p>
    <p class="events-item-days">May: 10th & 24th</p>
    <p class="events-item-days">June: 7th & 21st</p>
    <p class="events-item-days">July: 5th & 19th</p>
    <p class="events-item-days">August: 2nd, 16th & 30th</p>
    <p class="events-item-days">September: 27th</p>
    <p class="events-item-days">October: 11th & 25th</p>
  ...
  <div class="events-item">
    <h3 class="events-item-header">Essex Farmers Market</h3>
    <p class="events-item-daytime">Wednesdays, 3:30pm - 6:30pm</p>
    <p class="events-item-days">June: 18th & 25th</p>
    <p class="events-item-days">July: 2nd, 9th, 16th, 23rd & 30th</p>
    <p class="events-item-days">August: 6th, 13th, 20th & 27th</p>
    <p class="events-item-days">September: 3rd, 17th & 24th</p>
    <p class="events-item-days">October: 1st & 15th</p>
    <button class="events-item-button" data-id="essex">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54.757 54.757" height="25" width="25" role="img" title="map icon"><path d="M27.557 12c-3.86 0-7 3.14-7 7s3.14 7 7 7 7-3.14 7-7-3.14-7-7-7zm0 12c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"/><path d="M40.94 5.617C37.318 1.995 32.502 0 27.38 0c-5.123 0-9.938 1.995-13.56 5.617C7.117 12.32 6.284 24.93 12.016 32.57L27.38 54.756 42.72 32.6c5.756-7.67 4.923-20.28-1.78-26.983zm.16 25.814L27.38 51.244 13.64 31.4c-5.2-6.932-4.455-18.32 1.595-24.37C18.48 3.788 22.792 2 27.38 2s8.9 1.787 12.146 5.03c6.05 6.05 6.795 17.438 1.573 24.4z"/></svg>
      Find On The Map
    </button>
  </div>
  ...
  <!-- <div class="events-item">
    ...
    <p class="events-item-days">November: 23rd</p>
    <button class="events-item-button" data-id="montpelier">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54.757 54.757" height="25" width="25" role="img" title="map icon"><path d="M27.557 12c-3.86 0-7 3.14-7 7s3.14 7 7 7 7-3.14 7-7-3.14-7-7-7zm0 12c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"/><path d="M40.94 5.617C37.318 1.995 32.502 0 27.38 0c-5.123 0-9.938 1.995-13.56 5.617C7.117 12.32 6.284 24.93 12.016 32.57L27.38 54.756 42.72 32.6c5.756-7.67 4.923-20.28-1.78-26.983zm.16 25.814L27.38 51.244 13.64 31.4c-5.2-6.932-4.455-18.32 1.595-24.37C18.48 3.788 22.792 2 27.38 2s8.9 1.787 12.146 5.03c6.05 6.05 6.795 17.438 1.573 24.4z"/></svg>
      Find On The Map
    </button>
  ...
  <!-- <div class="events-item">
    ...
    <p class="events-item-days">Saturday, December 14th, 11:00pm - 2:00pm</p>
  ...
  <div class="events-item">
    ...
    <p class="events-item-days">October: 5th</p>
  ...
  <p class="events-item-daytime">Date to be determined</p>
  <p class="events-item-daytime">Held at Spruce Peak, Stowe Resort</p>
