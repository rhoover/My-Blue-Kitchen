...
<h2 class="events-list-header">My 2023 Appearances</h2>
<section class="events-items">
  <div class="events-item">
    ...
    <p class="events-item-days">October: 7th, 14th, 21st, 28th</p>
    <p class="events-item-days">December: 9th, 23rd</p>
    <p class="events-item-days">January: 13th, 27th</p>
    <p class="events-item-days">February: 10th, 24th</p>
    <p class="events-item-days">March: 9th, 23rd</p>
    <p class="events-item-days">April: 13th, 27th</p>
    <button class="events-item-button" data-id="montpelier-summer">
  ...
  <!-- <div class="events-item">
    <h3 class="events-item-header">Taste of New England - Stowe</h3>
    <p class="events-item-daytime">Sunday, 12:00pm - 4:00pm</p>
    <p class="events-item-days">August: 27th</p>
  ...
  <!-- <div class="events-item">
    ...
    <p class="events-item-days">October: 1st</p>
